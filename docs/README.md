...
| 14 | [`14-KEPUTUSAN-ARSITEKTUR-DATA.md`](./14-KEPUTUSAN-ARSITEKTUR-DATA.md) | **Keputusan akhir: Supabase, bukan Neon** | Semua |
...
| `14-KEPUTUSAN-ARSITEKTUR-DATA.md` | `[FINAL]` | **Keputusan akhir database** — koreksi analisis Neon |
